...
module.exports = {
  config: {
    ...
    aliases: ["ad","wlt"],
    version: "1.0.9",
    author: "AceGun | Base code by: Rehat",
    countDown: 5,
    role: 2,
    longDescription: {
  ...
  langs: {
    en: {
      ...
      missingIdAdd: "⚠️ | Please enter ID or tag user to add to admin",
      removed: "✅ | Removed admin role of %1 users:\n%2",
      notWhitelisted: "⚠️ | %1 users don't have admin role:\n%2",
      missingIdRemove: "⚠️ | Please enter ID or tag user to remove from admin",
      listWhitelisted: "👑 | List of Admin members:\n%1",
      enable: "😌",
      disable: "😐"
    }
  },
  ...
  onStart: async function ({ message, args, usersData, event }) {
    if (args.length === 0) {
      return message.reply(config.whiteListMode.enable ? "Ignore Admin mode is ON." : "Ignore admin mode is OFF.");
    }
    switch (args[0]) {
      case "add":
      case "a": {
