...
module.exports = {
  ...
  onStart: async function ({ message, args, api, event, usersData }) {
    ...
    try {
      const fcApiUrl = `https://api.screenshotone.com/take?access_key=ZpGiH4yUm-3fFw&url=https%3A%2F%2Fshahadats-fakechat-api.onrender.com%2F%3FprofileImageUrl%3D${encodeURIComponent(pfp)}%26name%3D${encodeURIComponent(userName)}%26text%3D${encodeURIComponent(prompt)}&full_page=true&viewport_width=2100&viewport_height=385&device_scale_factor=1&format=jpg&image_quality=100&block_ads=true&block_cookie_banners=true&block_banners_by_heuristics=false&block_trackers=true&delay=0&timeout=60`;
